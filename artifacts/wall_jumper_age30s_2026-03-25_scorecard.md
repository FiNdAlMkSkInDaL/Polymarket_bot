...
- Replay DB: `logs\universal_backtest_wall_jumper_age30s_2026-03-25.db`
- Replay source: `logs\local_snapshot\l2_data`
- Backtest log: `logs\universal_backtest_wall_jumper_age30s_2026-03-25.log`
...
- The `30000`ms wall-age gate was **positive** on `2026-03-25`: 60s net edge was `0.82290c/share` and total 60s simulated PnL was `$0.99`.
